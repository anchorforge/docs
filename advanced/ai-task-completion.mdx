...
Anchor Browser delivers a record 89% Score on the industry-standard benchmark WebVoyager, leveraging [browser-use](https://github.com/gregpr07/browser-use) as a core component of the automation capability.
