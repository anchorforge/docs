...
<CardGroup cols={2}>
  ...
  <Card title='Wait For Event API' icon='clock' href='/api-reference/event-coordination/wait-for-event'>
    API reference for waiting for events
  </Card>
  <Card title='Signal Event API' icon='signal' href='/api-reference/event-coordination/signal-event'>
    API reference for signaling events
  </Card>
</CardGroup>
````
