---
title: Cloudflare Web Bot Auth Integration
...
client = AnchorBrowser(api_key="your-api-key")
...
session = client.sessions.create(config)
...
// Initialize the client
const client = new AnchorBrowser({ apiKey: 'your-api-key' });
