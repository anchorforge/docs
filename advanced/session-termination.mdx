...
The AnchorBrowser API offers options to manage and gracefully terminate browser sessions through `session.timeout` object, using the `idle_timeout` and `max_duration` parameters.
