...
|-------|----------|----------|
| Claude Opus 4.5 | `claude-opus-4-5` | Most advanced reasoning, complex workflows **(default)** |
| Claude Sonnet 4.5 | `claude-sonnet-4-5` | Balanced performance, general automation |
| Claude Opus 4 | `claude-opus-4` | Advanced coding and agentic tasks |
| Claude Sonnet 4 | `claude-sonnet-4` | Fast, reliable automation |
