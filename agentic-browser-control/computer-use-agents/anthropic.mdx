...
|-------|----------|----------|
| Claude Opus 4.6 | `claude-opus-4-6` | Most advanced reasoning, complex workflows **(default)** |
| Claude Opus 4.5 | `claude-opus-4-5-20251101` | Previous generation, complex workflows |
...
| `model` | string | Claude model to use (default: `claude-opus-4-6`) |
...
- **Opus 4.6 is the default** - most capable model for complex workflows
