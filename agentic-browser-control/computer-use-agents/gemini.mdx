...
|-------|----------|----------|
| Gemini 2.5 Flash | `gemini-2.5-flash` | Quick automation tasks **(default)** |
| Gemini 3 Pro Preview | `gemini-3-pro-preview` | Most capable, complex reasoning |
| Gemini 3 Flash Preview | `gemini-3-flash-preview` | Fast responses, general tasks |
| Gemini 2.5 Pro | `gemini-2.5-pro` | Advanced multimodal understanding |
| Gemini 2.0 Flash | `gemini-2.0-flash` | Balanced speed and capability |
...
- **Gemini 2.5 Flash is the default** - excellent speed with strong capabilities
