---
title: 'Secret Values'
description: 'Securely pass credentials and sensitive data to AI agents'
icon: 'shield-check'
---
...
Secret values work with **all agent types**:

| Agent | Type | Secrets Support |
|-------|------|-----------------|
| `browser-use` | DOM-based | ✅ Full support |
| `openai-cua` | Screenshot-based | ✅ Full support |
| `anthropic-cua` | Screenshot-based | ✅ Full support |
| `gemini-computer-use` | Screenshot-based | ✅ Full support |
