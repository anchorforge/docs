---
title: 'Embedding End-User Authentication UI (Early Availability)'
description: 'Anchor provides an embeddable identity creation flow that allows end-users to authenticate to third-party websites directly from your application, enabling [authenticated browser sessions](/essentials/authenticated-applications).'
icon: 'window'
---
<Warning>
...
# Generate a token for identity creation
token_response = anchor_client.applications.createIdentityToken(
