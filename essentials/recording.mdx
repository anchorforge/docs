...
Start a session using the [SDK](/sdk-reference/browser-sessions/start-browser-session), you can enable recording by setting `recording: true` in the request body.
