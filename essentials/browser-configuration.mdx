  ...
  "proxy_config": 
    {
        ...
        "country": "COUNTRY_CODE" // Optional, defaults to empty
    }
}
```
...
- `country` - Optional country code; defaults to the best available proxy if left blank. Full list of country codes:
