...
<Step title="Save identity using the 'Create Profile' API">
**Without closing your current session**, go to the [sessions page](https://app.anchorbrowser.io/sessions) to get your session ID.
Then, use the [create profile](/api-reference/profile/create-a-new-profile) API to save the current browser context as a profile.
</Step>
