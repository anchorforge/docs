...
- Store authenticated sessions and identities
...
**Without closing your current session**, go to the [sessions page](https://app.anchorbrowser.io/sessions) to get your session ID.
</Step>
<Step title="Call the 'Create Profile' API">
Use the [create profile](/api-reference/profile/create-a-new-profile) API to save the current browser context as a profile.
</Step>
<Step title="Termintae the session">
Close the current session to save the profile.
</Step>
<Step title="Use the profile in a new session">
