...
|---------|------|---------|------|--------|------------|
| **Price** | $5 free credits/month | $50/month | $500/month | $2000/month | Custom |
| **Overage** | - | +$1.00/credit | +$1.00/credit | +$1.00/credit | Custom |
| **Concurrent browsers** | Up to 5 | Up to 25 | Up to 50 | Up to 200 | 500+ |
| **Credits per task** | 0.1 | 0.1 | 0.1 | 0.1 | Custom |
| **Browser sessions** | Up to 500 | Unlimited | Unlimited | Unlimited | Unlimited |
...
| Data retention | - | - | 30 days | Custom | Customizable (ZDR) |
