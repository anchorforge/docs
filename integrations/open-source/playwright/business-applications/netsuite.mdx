...
[View NetSuite's SuiteScript documentation](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/chapter_4387172211.html) for API alternatives when available.
