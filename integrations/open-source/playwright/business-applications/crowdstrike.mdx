---
title: "CrowdStrike"
description: "Automate CrowdStrike security workflows with Playwright when APIs aren't available."
icon: 'stars'
---
...
[View CrowdStrike's API documentation](https://falcon.crowdstrike.com/documentation/) for integration services when available.
