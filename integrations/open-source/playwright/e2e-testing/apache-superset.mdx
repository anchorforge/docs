...
description: "Test Apache Superset dashboards and data visualization workflows with Playwright's end-to-end testing framework."
icon: 'stars'
---
...
[View Superset's Playwright configuration](https://github.com/apache/superset/blob/main/superset-frontend/playwright.config.ts) from the official repository.
