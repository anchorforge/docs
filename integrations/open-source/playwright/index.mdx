...
- [API Reference](/sdk-reference/browser-sessions/start-browser-session) - Complete Playwright method documentation
- [Examples](/examples/form-filling) - Real-world Playwright automation scripts
- [Browser Configuration](/sdk-reference/browser-sessions/start-browser-session#body-browser) - Advanced browser settings and options
