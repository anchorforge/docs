...
description: "Automate VA disability compensation application workflows with Playwright when APIs aren't available."
icon: 'stars'
---
...
Create scripts for common VA Form 21-526EZ tasks:
...
// Navigate to VA.gov
await page.goto('https://www.va.gov/disability/file-disability-claim-form-21-526ez/');
await page.click('[data-testid="sign-in-button"]');
await page.fill('[data-testid="username"]', process.env.VA_USERNAME);
await page.fill('[data-testid="password"]', process.env.VA_PASSWORD);
