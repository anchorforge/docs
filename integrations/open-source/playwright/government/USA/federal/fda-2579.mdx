---
title: "FDA Form 2579"
description: "Automate FDA food facility registration workflows with Playwright when APIs aren't available."
icon: 'stars'
---
...
// Navigate to FDA Food Facility Registration system
await page.goto('https://www.access.fda.gov/scripts/furls/');
await page.fill('[data-testid="username"]', process.env.FDA_USERNAME);
await page.fill('[data-testid="password"]', process.env.FDA_PASSWORD);
