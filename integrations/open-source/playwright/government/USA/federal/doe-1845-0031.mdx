---
title: "DOE Form 1845-0031"
description: "Automate federal student loan forbearance request workflows with Playwright when APIs aren't available."
icon: 'stars'
---
...
// Navigate to Federal Student Aid system
await page.goto('https://studentaid.gov/login');
await page.fill('[data-testid="username"]', process.env.FSA_USERNAME);
await page.fill('[data-testid="password"]', process.env.FSA_PASSWORD);
