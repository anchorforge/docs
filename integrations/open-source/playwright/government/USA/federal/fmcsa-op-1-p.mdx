...
Create scripts for common FMCSA Form OP-1(P) tasks:
...
// Navigate to FMCSA Unified Registration System
await page.goto('https://portal.fmcsa.dot.gov/UrsRegistrationWizard/');
await page.fill('[data-testid="username"]', process.env.FMCSA_USERNAME);
await page.fill('[data-testid="password"]', process.env.FMCSA_PASSWORD);
await page.click('[data-testid="login-button"]');

// Start new OP-1(P) application
await page.click('[data-testid="new-application"]');
await page.selectOption('[name="application_type"]', 'property_carrier_authority');
...
await page.selectOption('[name="property_type"]', 'general_freight');
await page.check('[name="household_goods"]');
await page.check('[name="commodities_refrigerated"]');
