---
title: "IRS Form W-7"
description: "Automate ITIN application workflows with Playwright when APIs aren't available."
icon: 'stars'
---
...
Create scripts for common IRS Form W-7 tasks:
...
await page.goto('https://www.irs.gov/individuals/itin-application');
