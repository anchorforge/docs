---
title: "BLM Form 3510"
description: "Automate BLM mineral operations reporting workflows with Playwright when APIs aren't available."
icon: 'stars'
---
...
[View BLM's developer resources](https://www.blm.gov/services/geospatial/GISData) for available APIs when applicable.
...
await page.goto('https://www.blm.gov/services/minerals');
await page.fill('[data-testid="username"]', process.env.BLM_USERNAME);
await page.fill('[data-testid="password"]', process.env.BLM_PASSWORD);
