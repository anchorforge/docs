---
title: "OWCP Form 915"
description: "Automate federal workers' compensation claim workflows with Playwright when APIs aren't available."
icon: 'stars'
---
...
Create scripts for common OWCP Form 915 tasks:
...
await page.goto('https://www.ecomp.dol.gov/');
await page.fill('[data-testid="username"]', process.env.OWCP_USERNAME);
await page.fill('[data-testid="password"]', process.env.OWCP_PASSWORD);
