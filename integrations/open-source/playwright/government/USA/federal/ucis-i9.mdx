...
description: "Automate employment eligibility verification workflows with Playwright when APIs aren't available."
icon: 'stars'
---
...
Create scripts for common USCIS Form I-9 tasks:
...
await page.goto('https://www.e-verify.gov/employers');
