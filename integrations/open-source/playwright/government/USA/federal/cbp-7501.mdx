---
title: "CBP Form 7501"
description: "Automate CBP Form 7501 entry documentation workflows with Playwright when APIs aren't available."
icon: 'stars'
---
...
Create scripts for common CBP Form 7501 tasks:
...
// Navigate to CBP ACE system
await page.goto('https://ace.cbp.dhs.gov/');
await page.fill('[data-testid="username"]', process.env.CBP_USERNAME);
await page.fill('[data-testid="password"]', process.env.CBP_PASSWORD);
