---
title: "FinCEN 105 (CMIR)"
description: "Automate FinCEN 105 currency reporting workflows with Playwright when APIs aren't available."
icon: 'stars'
---
...
Create scripts for common FinCEN 105 tasks:
...
await page.goto('https://fincen105.cbp.dhs.gov/#/');
