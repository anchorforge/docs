---
title: "CMS Form 10069"
description: "Automate Medicare provider enrollment and certification workflows with Playwright when APIs aren't available."
icon: 'stars'
---
...
await page.goto('https://pecos.cms.hhs.gov/');
await page.fill('[data-testid="username"]', process.env.CMS_USERNAME);
await page.fill('[data-testid="password"]', process.env.CMS_PASSWORD);
