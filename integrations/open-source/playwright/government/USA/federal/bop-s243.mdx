---
title: "BOP Form BP-S0243"
description: "Automate Bureau of Prisons inmate request workflows with Playwright when APIs aren't available."
icon: 'stars'
---
...
Create scripts for common BOP Form BP-S0243 tasks:
...
// Navigate to BOP TRULINCS system
await page.goto('https://www.bop.gov/inmateloc/');
await page.fill('[data-testid="username"]', process.env.BOP_USERNAME);
await page.fill('[data-testid="password"]', process.env.BOP_PASSWORD);
