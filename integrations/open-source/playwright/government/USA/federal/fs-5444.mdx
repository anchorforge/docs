---
title: "FS Form 5444"
description: "Automate TreasuryDirect account authorization workflows with Playwright when APIs aren't available."
icon: 'stars'
---
...
Create scripts for common FS Form 5444 tasks:
...
await page.goto('https://www.treasurydirect.gov/login');
await page.fill('[data-testid="username"]', process.env.TD_USERNAME);
await page.fill('[data-testid="password"]', process.env.TD_PASSWORD);
