---
title: "Form 122A-1"
description: "Automate Chapter 7 bankruptcy means test and income statement workflows with Playwright when APIs aren't available."
icon: 'stars'
---
...
Create scripts for common Form 122A-1 tasks:
