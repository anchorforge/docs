---
title: "FMCSA Form BMC-40"
description: "Automate motor carrier surety bond and trust fund filing workflows with Playwright when APIs aren't available."
icon: 'stars'
---
...
Create scripts for common FMCSA Form BMC-40 tasks:
...
await page.goto('https://li-public.fmcsa.dot.gov/');
