---
title: "CCC Form 941"
description: "Automate USDA farm program income certification workflows with Playwright when APIs aren't available."
icon: 'stars'
---
...
await page.fill('[data-testid="username"]', process.env.USDA_USERNAME);
await page.fill('[data-testid="password"]', process.env.USDA_PASSWORD);
