---
title: 'Stagehand'
description: 'Integrate Stagehand with Anchor Browser for AI-powered browser automation'
icon: 'stars'
---

[Stagehand](https://github.com/browserbasehq/stagehand) is an AI-powered browser automation framework that uses LLMs to perform natural language browser tasks. Connect Stagehand to Anchor Browser via CDP to leverage cloud infrastructure, proxy support, and session management.
